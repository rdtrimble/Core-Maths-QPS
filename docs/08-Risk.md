...
- u4 Be able to interpret two-way tables and use them to calculate or estimate probability.
- u5 Understand the difference between dependent and independent events and be able to calculate probability in simple cases.
- u6 Be able to work with a tree diagram when calculating or estimating a probability, including conditional probability.
