...
N = function(x) 2^(3*x)
plot.function(N, from = 0, to = 2, n = 6, type="p", pch=16, yaxt="n", xlab="Time (t) in hours", ylab="N")
...
N = function(x) 2^(3*x)
plot.function(N, from = 0, to = 5, n = 15, type="p", pch=16, yaxt="n", xlab="Time (t) in hours", ylab="N")
